...
public abstract class AbstractKoreanParser {
    ...
    public String parse(String token) {
        ...
        for (char ch : arrCh) {
            ...
            char unicodeIndex = (char) (ch - JasoUnicodeConstant.START_KOREA_UNICODE);
            ...
            if (unicodeIndex >= 0 && unicodeIndex <= 11184) {
                ...
                char chosung = JasoUnicodeConstant.UNICODE_CHO_SUNG[idxChoSung];

                // 중성 유니코드
                int idxJungSung = unicodeIndex % (28 * 21) / 28;
                char jungsung = JasoUnicodeConstant.UNICODE_JUNG_SUNG[idxJungSung];

                // 종성 유니코드
                int idxJongSung = unicodeIndex % (28 * 21) % 28;
                char jongsung = JasoUnicodeConstant.UNICODE_JONG_SUNG[idxJongSung];
